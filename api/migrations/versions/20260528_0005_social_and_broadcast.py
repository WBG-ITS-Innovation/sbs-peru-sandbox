...
# part-17 excision: the persona_scope (0004) migration was removed with the
# RESHAPE/persona-cockpit subsystem; re-link this revision onto
# pattern_detections (0001) to keep the chain linear.

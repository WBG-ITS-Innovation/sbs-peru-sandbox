...
# part-17 excision: the chatbot (0006) migration was removed with the
# RESHAPE/insight-chatbot subsystem; re-link this revision onto
# social_and_broadcast (0005) to keep the chain linear.

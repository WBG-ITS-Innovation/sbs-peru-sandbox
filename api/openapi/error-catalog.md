...
| SBS-409-002 | 409 | Idempotency replay mismatch | Recoverable | The Idempotency-Key was reused but with a different request body. | Use a new Idempotency-Key, or replay the original body verbatim. |

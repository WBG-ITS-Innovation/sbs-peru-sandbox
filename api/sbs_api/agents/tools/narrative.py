...
Spanish for Superintendent or the Supervisor lead.
"""
...
# Analyst's edit during the demo fills exactly that gap.
DEMO_DRAFT = (
...
class SummarizeForExecutiveTool(Tool):
    ...
    description = (
        ...
        "summary. Audience: 'superintendent' (Superintendent) or 'supervisor' "
        "(the Supervisor)."
    )

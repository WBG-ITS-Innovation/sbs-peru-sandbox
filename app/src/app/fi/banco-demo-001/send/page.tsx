...
// Bank-side send console for BANCO_DEMO_001 (SBS-001234). Renders under the
// FI (bank) chrome — NOT the SBS portal. The bank sends complaints INTO SBS
// over the real Tier-1 (granular) and Tier-2 (batch) channels.
export const dynamic = 'force-dynamic';

export default async function BancoSendPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <SandboxControl locale={locale} fixedProfile="banco-tier1" />
    </div>
  );
}

...
- **Fidelity tiers:** ADR 0036 documents how synthetic records approximate the statistical shape of the Annex 1-A schema — 27 fields under Res. SBS N° 04036-2022 (23 base + 4 conditional bancaseguros), of which the API implements a curated 15-field subset per [ADR 0026](adr/0026-anexo-1a-curated-subset.md) — without deriving from real submissions.

...
- [ ] Plain-language onboarding overview readable by the Executive (deferred to post-sprint v0.2).
...
- [ ] Plain-language operations summary readable by the Executive.
...
- [ ] Plain-language explainability note: how each model is evaluated, in language the Supervisor can read.
...
- [ ] Plain-language Standards Pack overview readable by the Superintendent and the Executive.
